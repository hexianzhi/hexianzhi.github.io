/**
 * Created by gedune on 2017/4/19.
 */
/* 数据格式演示
 var aqiSourceData = {
 "北京": {
...
function renderChart() {
    ...
    for (var item in chartData) {
        ...
        str += "<div title='" + chartData[item]
            + "' style='height:" + chartData[item] + "px;background-color:" + color
            + "'></div>";
...
function initCitySelector() {
    ...
    addEventHandler(citySelect, 'click', citySelectChange);
